...
**Docs:**
- [docs/IMPLEMENTATION.md](docs/IMPLEMENTATION.md) — status, request flow, full API
  reference, and a file-by-file walkthrough of every module.
- [docs/DEMO.md](docs/DEMO.md) — setup, `scripts/demo.py`, implemented-vs-deferred table.
